...
var PropValidatorTestComponent =
/*#__PURE__*/
function (_PropValidator) {
  _inherits(PropValidatorTestComponent, _PropValidator);

  function PropValidatorTestComponent() {
    _classCallCheck(this, PropValidatorTestComponent);

    return _possibleConstructorReturn(this, _getPrototypeOf(PropValidatorTestComponent).apply(this, arguments));
  }
